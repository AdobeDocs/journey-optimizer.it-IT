...
[Ulteriori informazioni su “distingui”](../using/building-journeys/functions/list-functions.md#distinct)
:::
...
[Informazioni su “distinctWithNull”](../using/building-journeys/functions/list-functions.md#distinctWithNull)
:::
...
[Esplora i dettagli della funzione “filtra”](../using/building-journeys/functions/list-functions.md#filter)
:::
...
[Informazioni sulla funzione “getListItem”](../using/building-journeys/functions/list-functions.md#getListItem)
:::
...
[Ulteriori informazioni sulla funzione “in”](../using/building-journeys/functions/list-functions.md#in)
:::
...
[Informazioni approfondite sulla funzione “intersect”](../using/building-journeys/functions/list-functions.md#intersect)
:::
...
- **[Utilizzo della funzione `limit` in Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#limit)** - Scopri come limitare un elenco al primo o all’ultimo N elementi utilizzando la funzione “limit”.
- **[Riferimento alla funzione listSize](../using/building-journeys/functions/list-functions.md#listSize)** - Scopri come contare il numero di elementi in un elenco utilizzando la funzione ’listSize’.
- **[Funzione serializeList in Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#serializeList)** - Converti gli elenchi in stringhe con formattazione personalizzabile utilizzando la funzione “serializeList”.
- **[Funzione sort in Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#sort)** - Scopri come ordinare elenchi di valori o oggetti in ordine naturale utilizzando la funzione “sort”.
