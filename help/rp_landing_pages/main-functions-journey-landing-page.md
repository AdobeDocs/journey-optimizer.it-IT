...
[Approfondisci le funzioni di aggregazione](../using/building-journeys/functions/aggregation-functions.md)
:::
...
[Scopri le funzioni di conversione](../using/building-journeys/functions/conversion-functions.md)
:::
...
[Consulta la documentazione sulle funzioni di data](../using/building-journeys/functions/date-functions.md)
:::
...
[Consulta le funzioni elenco](../using/building-journeys/functions/list-functions.md)
:::
