...
Non sei sicuro di quale dei tre metodi di convalida del percorso utilizzare? Consulta [Scegliere come verificare e convalidare il percorso](../using/building-journeys/choose-validation-method.md) per un confronto completo.
