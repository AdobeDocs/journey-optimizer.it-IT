...
description: Scopri come creare rapporti di gestione delle decisioni utilizzando i set di dati evento e lo schema XDM di DecisioningEvents per analizzare le prestazioni delle offerte e i risultati delle decisioni.
...
Utilizza i dati evento di gestione delle decisioni e lo schema XDM di DecisioningEvents per creare rapporti personalizzati in Adobe Journey Optimizer. Questa sezione illustra come utilizzare i set di dati evento e accedere ai campi XDM necessari per analizzare le selezioni delle offerte, l’utilizzo del fallback e l’efficacia del posizionamento.
