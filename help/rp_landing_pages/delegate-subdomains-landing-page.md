...
Eseguire la migrazione da CNAME a delega personalizzata

Esegui la migrazione dei sottodomini configurati come CNAME esistenti alla delega personalizzata per soddisfare i criteri di sicurezza e ottenere il controllo completo sui certificati.

[Eseguire la migrazione di un sottodominio](../using/configuration/custom-subdomain-migration.md)
:::
...
- **[Configurare i sottodomini della pagina di destinazione](../using/landing-pages/lp-subdomains.md)** - Configura i sottodomini per le pagine di destinazione e i moduli di abbonamento.
- **[Configurare i sottodomini web](../using/web/web-delegated-subdomains.md)** - Delega i sottodomini per esperienze web e monitoraggio.
