...
- **[API basate sull&#39;intelligenza artificiale](../using/configuration/ajo-apis.md)** - Accedi alle funzionalità di intelligenza artificiale e machine learning di Journey Optimizer a livello di programmazione tramite API RESTful.
