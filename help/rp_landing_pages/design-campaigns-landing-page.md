...
Sincronizza più rami di esecuzione assicurandoti che le attività precedenti vengano completate prima di continuare.
...
Segmenta le popolazioni in entrata combinando, escludendo o intersecando dati.
...
- **[Attività Arricchimento](../using/orchestrated/activities/enrichment.md)**: migliora i dati del pubblico con attributi aggiuntivi per una migliore segmentazione e personalizzazione.
