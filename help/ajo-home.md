...
>[!CAUTION]
>
>Il 22 luglio, Adobe Journey Optimizer ha rilasciato un [nuova funzionalità](using/rn/inline-messages.md) che migliora il modo in cui crei contenuti per i canali Journey Optimizer (e-mail, push, SMS). In qualità di utente business di Journey Optimizer, adesso puoi [creare](using/messages/get-started-content.md) i messaggi direttamente da un percorso. Varrà eseguita la conversione automatica dei percorsi. Ma abbiamo bisogno del tuo aiuto in alcuni passaggi. Ulteriori informazioni sui [passaggi richiesti](using/rn/inline-messages-steps.md).
