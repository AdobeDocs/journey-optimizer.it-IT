...
Dai un’occhiata ai più recenti miglioramenti introdotti in Journey Optimizer. Per un elenco completo delle funzioni, dei miglioramenti e delle correzioni, consulta la [Note sulla versione](using/rn/release-notes.md).
...
>[!TAB MMS (Multimedia Message Service) negli SMS]
...
[![immagine](using/assets/do-not-localize/learn-more-button.svg)](using/sms/create-sms.md#sms-content)
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Interfaccia utente</strong><br/>Scopri come navigare e ottimizzare la tua esperienza in Journey Optimizer.</div><br/>
    </td>
    <td>
