...
+ Introduzione {#get-started}
  ...
  + [Utilizzare l’IA](using/start/ai-features.md)
...
+ Percorsi {#orchestrate-journeys}
  ...
  + [Coworker per percorsi](using/building-journeys/journeys-coworker-skills.md)
  + Creare un percorso {#create-journey}
    ...
    + Convalidare il percorso {#validate-journey}
      + [Scegliere un metodo di convalida](using/building-journeys/choose-validation-method.md)
  ...
  + Attività {#about-journey-building}
    ...
    + [Tipi di percorso: scegli quello giusto](using/building-journeys/journey-types-selection.md)
    ...
    + Ottimizzare {#optimize-activity}
      ...
      + [Targeting del percorso](using/building-journeys/path-targeting.md)
    ...
    + [Frammenti di percorso](using/building-journeys/journey-fragments.md)
  ...
  + Creare espressioni {#building-advanced-conditions-journeys}
    ...
    + Sintassi {#syntax}
      ...
      + {hide-from-toc}[Esempi](using/building-journeys/expression/advanced-editor-use-cases.md)
...
+ Sfide fedeltà {#loyalty-challenges}
  ...
  + [Coworker per fedeltà](using/loyalty-challenges/loyalty-coworker-skills.md)
...
+ Campagne {#campaigns}
  ...
  + Campagne attivate da API {#api-triggered-campaigns}
    ...
    + [Attivare la modalità di velocità effettiva per campagne attivate da API](using/campaigns/api-triggered-high-throughput.md)
  + Campagne orchestrate {#orchestrated-campaigns}
    ...
    + Eseguire query sul database {#query-database}
      ...
      + [Utilizzare filtri preimpostati](using/orchestrated/predefined-filters.md)
...
+ Testare e approvare {#test}
  ...
  + Anteprima e test del contenuto {#preview-test}
    ...
    + {hide-from-toc}[Simulare esperienze in entrata](using/test-approve/simulate-inbound-experiences.md)
...
+ Canali di comunicazione {#channels}
  ...
  + Canale e-mail {#email}
    ...
    + Progettare i contenuti e-mail {#design-email}
      + {hide-from-toc}[Progettare i contenuti e-mail](/help/rp_landing_pages/design-email-landing-page.md)
      + {hide-from-toc}[Progettare il contenuto del messaggio](using/start/message-content-design.md)
      ...
      + Iniziare a creare contenuti {#start-creating-content}
        + {hide-from-toc}[Iniziare a creare contenuti](/help/rp_landing_pages/start-creating-content-landing-page.md)
      ...
      + Creare i contenuti {#add-content}
        ...
        + [Ottimizzare le e-mail per le caselle in entrata IA](using/email/llm-email-optimizer.md)
        + [Gestire la versione del testo](using/email/text-version-email.md)
        + [Aggiungere metadati](using/email/email-metadata.md)
        + [Modificare con l’editor HTML avanzato](using/email/email-expert-mode.md)
      + Modificare lo stile {#edit-style}
        + {hide-from-toc}[Modificare lo stile](/help/rp_landing_pages/edit-style-landing-page.md)
      ...
      + [Collaborare al contenuto delle e-mail](using/email/email-collaboration.md)
    ...
    + [Utilizzare e configurare i collegamenti di approfondimento](using/email/deeplinks.md)
  ...
  + Canale SMS/MMS/RCS {#mobile}
    ...
    + [Verificare e inviare i messaggi per i dispositivi mobili](using/mobile/send-mobile-message.md)
    ...
    + Configurare il canale mobile {#configure-mobile}
      ...
      + [Configurare il provider Twilio](using/mobile/mobile-configuration-twilio.md)
      + [Configurare un provider personalizzato](using/mobile/mobile-configuration-custom.md)
      + [Creare webhook](using/mobile/mobile-webhook.md)
      + [Creare una configurazione mobile](using/mobile/mobile-configuration-surface.md)
      + [Utilizzare un set di dati personalizzato per le parole chiave in entrata](using/mobile/custom-dataset-inbound-keywords.md)
  ...
  + Canali personalizzati {#custom-channel}
    + [Introduzione ai canali personalizzati](using/custom-channel/get-started-custom-channel.md)
    + Configurare i canali personalizzati {#configure-custom-channel}
      + [Configurare i canali personalizzati](using/custom-channel/configure-custom-channel.md)
      + [Creare un canale personalizzato](using/custom-channel/create-custom-channel.md)
...
+ Gestione dei contenuti {#content-management}
  ...
  + [Coworker per la gestione dei contenuti](using/content-management/content-management-coworker-skills.md)
  + Personalizzazione {#personalization}
    ...
    + Casi d’uso della personalizzazione {#personalization-use-cases}
      ...
      + [Ricette di personalizzazione](using/personalization/personalization-recipes.md)
  ...
  + Pagine di destinazione {#landing-pages}
    ...
    + Configurare le pagine di destinazione {#lp-configuration}
      ...
      + [Definire i predefiniti delle pagine di destinazione](using/landing-pages/lp-presets.md)
  + Modelli di contenuto {#content-templates}
    ...
    + [Convertire immagini in modelli e-mail](using/content-management/image-to-html.md)
  ...
  + Casi d’uso per più soluzioni {#combine}
    ...
    + [Integrare con Intelligent Services](using/integrations/intelligent-services.md)
  ...
  + Generazione di contenuti {#generate-content}
    ...
    + Metadati C2PA {#c2pa}
      + [Metadati C2PA in Genera contenuti](using/content-management/generative-c2pa-metadata.md)
    ...
    + Brand {#brands}
      ...
      + [Creare e gestire i modelli generativi](using/content-management/generative-models.md)
...
+ Generazione di rapporti {#reporting}
  ...
  + Rapporto tutte le ore {#channel-report}
    ...
    + Rapporti sulla campagna {#campaign-reporting}
      ...
      + {hide-from-toc}[Rapporto della campagna di attività live](using/reports/campaign-global-report-cja-activity.md)
...
+ Funzionalità di decisione {#decisioning}
  ...
  + Funzione Decisioni {#experience-decisioning}
    ...
    + [Collaboratore per Decisioning](using/experience-decisioning/experience-decisioning-coworker-skills.md)
    ...
    + Migrare a Decisioning {#migrate-to-decisioning}
      ...
      + [API della migrazione a Decisioning](using/experience-decisioning/decisioning-migration-api.md)
    + Riferimento API {#experience-decisioning-api-reference}
      + {hide-from-toc}[Riferimento API](/help/rp_landing_pages/experience-decisioning-api-reference-landing-page.md)
    ...
    + Creare i ranking {#experience-decisioning-rankings}
      ...
      + Modelli di IA {#experience-decisioning-ai-models}
        ...
        + [Monitorare le prestazioni dei modelli IA](using/experience-decisioning/ranking/ai-model-observability.md)
    ...
    + Raccogliere dati evento {#experience-decisioning-collect-event-data}
      + {hide-from-toc}[Guida introduttiva alla raccolta dati](using/experience-decisioning/data-collection/data-collection.md)
      + {hide-from-toc}[Creare un set di dati per raccogliere gli eventi](using/experience-decisioning/data-collection/create-dataset.md)
...
+ Configurazione dei canali {#configuration}
  ...
  + {hide-from-toc}[Schema di esportazione dei messaggi di AJO](using/configuration/message-export-schema.md)
  ...
  + Delegare i sottodomini e-mail {#delegate-subdomains}
    ...
    + [Migrare da CNAME a delega personalizzata](using/configuration/custom-subdomain-migration.md)
  ...
  + Implementare un piano di preparazione IP {#implement-ip-warmup-plan}
    ...
    + {hide-from-toc}[File del piano di preparazione IP](using/configuration/ip-warmup-plan-files.md)
  + Monitorare gli indirizzi e-mail {#monitor-reputation}
    ...
    + {hide-from-toc}[Tipi di errori e-mail](using/configuration/email-error-types.md)
  ...
  + [Supporto per l’archiviazione e-mail](using/configuration/archiving-support.md)
  ...
  + [Gestire gli IP consentiti](using/configuration/waf-ip-allowlist.md)
