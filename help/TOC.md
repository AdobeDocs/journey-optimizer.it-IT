...
+ Novità {#whats-new}
   ...
   + Nuova funzione di authoring in linea {#inline-authoring}
      + [Panoramica sulla migrazione](using/rn/inline-messages.md)
      + [Passaggi di migrazione](using/rn/inline-messages-steps.md)
...
+ Personalizzazione{#personalization}
   ...
   + Contenuto dinamico {#dynamic}
      ...
      + [Creare condizioni](using/personalization/create-conditions.md)
      + [Creare contenuto condizionale](using/personalization/dynamic-content.md)
...
+ Configurazione{#configuration}
   ...
   + Configurare i messaggi {#configuration-message}
      + Configurare le notifiche push{#push-config}
         + [Introduzione alla configurazione push](using/configuration/push-gs.md)
         + [Configurare il canale di notifica push](using/configuration/push-configuration.md)
      + Configurare le e-mail {#email-configuration}
