...
+ Percorsi {#orchestrate-journeys}
   ...
   + Gestire i percorsi{#manage-journey}
      ...
      + [Gestione dei tag nei percorsi](using/building-journeys/tags.md)
...
+ Campagne{#campaigns}
   ...
   + Esperimento sui contenuti {#content-experiment}
      ...
      + [Calcoli statistici nel rapporto di sperimentazione](using/campaigns/experiment-report-calculations.md)
...
+ Canale e-mail {#email}
   ...
   + Progettare i contenuti delle e-mail {#design-email}
      ...
      + Iniziare a creare contenuti {#start-creating-content}
         ...
         + [Importa il contenuto delle e-mail](using/email/existing-content.md)
...
+ Gestione dei dati {#data-management}
   ...
   + [Schemi incorporati Journey Optimizer](https://experienceleague.adobe.com/tools/ajo-schemas/schema-dictionary.html)
