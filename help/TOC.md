...
+ Introduzione {#get-started}
   ...
   + {hide-from-toc}[Hub di onboarding](using/start/onboarding-hub.md)
   + Elementi di base {#essentials}
      ...
      + {hide-from-toc}[Quale funzionalità per questo processo?](using/start/ajo-use-case-guide.md)
      ...
      + {hide-from-toc}[Pacchetti e funzionalità (v3)](using/start/ajo-packages-v3.md)
   ...
   + Lavorare in modo efficiente {#work-efficiently}
      ...
      + {hide-from-toc}[Percorsi o campagne](using/start/journeys-vs-campaigns.md)
+ Percorsi {#orchestrate-journeys}
   ...
   + {hide-from-toc}[Tipi di percorso e guida alla selezione](using/building-journeys/journey-types-selection.md)
...
+ Campagne {#campaigns}
   ...
   + Campagne orchestrate {#orchestrated-campaigns}
      ...
      + Attività campagne orchestrate {#design-campaigns}
         ...
         + {hide-from-toc}[Carica file](using/orchestrated/activities/load-file.md)
