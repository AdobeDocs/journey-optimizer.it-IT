...
**In questa pagina:** configura e gestisci le chiavi gestite dal cliente (CMK) per crittografare i dati di Adobe Journey Optimizer con le tue chiavi e mantenerli protetti sia in transito che a riposo.
