...
1. Da E-mail Designer, aggiungi almeno un **[!UICONTROL Structure components]** per iniziare a progettare l’e-mail.

1. Fai clic sul pulsante **[!UICONTROL Navigation tree]** nel riquadro a sinistra e seleziona **[!UICONTROL Body]**.

   ![](assets/preheader_body.png)

1. Da **[!UICONTROL Body settings]** nel riquadro a destra, fai clic sull’icona di modifica accanto a **[!UICONTROL Preheader]** campo per aggiungere contenuto.
