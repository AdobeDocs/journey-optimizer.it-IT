...
>title="Definire la configurazione di indirizzamento dei file"
>abstract="Dopo aver creato un messaggio di direct mailing, il file contenente i dati del pubblico di destinazione verrà generato ed esportato su un server. È necessario specificare i dettagli del server in modo che il provider di direct mailing possa accedere al file e utilizzarlo per la consegna della direct mailing."
...
>title="Definire la configurazione di indirizzamento dei file"
>abstract="È necessario definire dove verrà esportato il file che il provider di direct mailing dovrà utilizzare."
...
>abstract="Scegliere il tipo di server da utilizzare per esportare i file di direct mailing. Attualmente Journey Optimizer supporta solo Amazon S3 e SFTP."

>[!CONTEXTUALHELP]
>id="ajo_dm_file_routing_aws_region"
>title="Scegli l’area geografica di AWS"
>abstract="Seleziona l’area geografica del server AWS in cui desideri esportare i file di direct mailing. Come pratica generale, è preferibile scegliere l’area più vicina alla posizione del provider di direct mailing."
...
>title="Definire la soglia di suddivisione dei file"
>abstract="Devi impostare il numero massimo di record per ogni file contenente dati sul pubblico. È possibile selezionare un numero qualsiasi compreso tra 1 e 200.000 record. Al raggiungimento della soglia specificata, verrà creato un altro file per i record rimanenti."
