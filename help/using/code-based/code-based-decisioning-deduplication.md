...
Quando utilizzi [i criteri decisionali](../experience-decisioning/create-decision.md) nelle esperienze basate sul codice, scopri come applicare la deduplicazione alle richieste di decisioning nell’implementazione del cliente.
...
Per impostazione predefinita, il flag di deduplicazione è impostato su `true` (non viene passato).
