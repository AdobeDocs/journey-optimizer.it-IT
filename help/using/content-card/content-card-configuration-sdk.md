...
1. Includi e configura [Web SDK](https://experienceleague.adobe.com/en/docs/experience-platform/web-sdk/home) nella pagina utilizzando le impostazioni del file `.env` nella cartella di esempio.
