...
**In questa pagina:** Scopri come impostare i prerequisiti di consegna e creare una configurazione del canale in-app per inviare messaggi in-app con Adobe Journey Optimizer.
