...
* È ora disponibile una nuova pagina con **demo interattiva** per le sfide di fidelizzazione, con un collegamento a una demo autoguidata e cliccabile che copre il flusso di creazione per la sfida dell’addetto al marketing (inclusa l’opzione Porta i tuoi dati e dashboard di insight), l’esperienza del cliente finale e la gestione delle sfide di fidelizzazione in CX Coworker. [Ulteriori informazioni](../loyalty-challenges/loyalty-challenges-demo.md)

* La pagina **Personalizzare lo sfondo delle e-mail** è stata ampliata e migliorata. Ora documenta l’intero elenco a discesa **Posizionamento immagine** per le immagini di sfondo e aggiunge nuove best practice per i colori e le immagini di sfondo, con il consiglio di testare tali immagini su client e-mail reali anziché affidarsi esclusivamente all’anteprima di E-mail designer. [Ulteriori informazioni](../email/backgrounds.md)

* La pagina **Progettare contenuto da zero con E-mail designer** è stata riorganizzata e resa più chiara: distingue la struttura a **[!UICONTROL n:n colonne]** da quelle con predefiniti fissi, documenta che il numero delle colonne di una struttura può essere aumentato senza perdere i contenuti esistenti, spiega il comportamento di impilamento delle colonne su dispositivi mobili e aggiunge un nuovo passaggio sull’utilizzo dei **[!UICONTROL Moduli]** per la creazione rapida di e-mail. [Ulteriori informazioni](../email/content-from-scratch.md)

* La pagina **Progettare il percorso** include ora una sezione completa di tutorial sull’esperienza della nuova area di lavoro, che illustra come aggiungere attività, utilizzare le icone della barra degli strumenti, selezionare più attività per azioni in blocco, copiare e incollare attività e unire o scollegare rami. [Ulteriori informazioni](../building-journeys/using-the-journey-designer.md#canvas-capabilities)

* Sono state aggiunte nuove linee guida per la verifica della consegna delle azioni personalizzate: la pagina **Esempi di query per set di dati** spiega ora come scegliere tra set di dati di eventi di feedback dei messaggi, tracciamento delle e-mail e eventi dei passaggi del percorso a seconda del tipo di azione e documenta come risolvere l’errore “Tabella non predisposta per il set di dati”. Le pagine **Panoramica degli eventi dei passaggi del percorso** e **Risoluzione dei problemi di esecuzione del percorso attivo** sono state aggiornate di conseguenza, chiarendo che una chiamata di azione personalizzata riuscita conferma solo l’esecuzione dell’azione da parte di Journey Optimizer e non l’effettiva consegna del messaggio da parte del sistema esterno. [Ulteriori informazioni](../data/datasets-query-examples.md#choose-the-correct-dataset)

* Le informazioni su CX Coworker sono state aggiunte alla pagina **Utilizzare l’IA** e illustrano cos’è CX Coworker, come si relaziona all’Assistente IA e i riferimenti alla documentazione ufficiale. Sono state aggiunte pagine dedicate alle competenze in ogni guida alle funzionalità: [Competenze CX Coworker per i percorsi](../building-journeys/journeys-coworker-skills.md), [Competenze CX Coworker per la fedeltà](../loyalty-challenges/loyalty-coworker-skills.md) e [Strumenti di gestione dei contenuti di CX Coworker](../content-management/content-management-coworker-skills.md). [Ulteriori informazioni](../start/ai-features.md#cx-coworker)

* Una nuova competenza **Analizzare le anomalie del percorso** è stata documentata in **Analisi del percorso** nella pagina CX Coworker. Rileva picchi, cali o azzeramenti imprevisti in entrata, uscita o all’invio di un percorso rispetto alle linee di base cronologiche ed esegue una diagnostica di sola lettura per individuare una probabile causa principale. [Ulteriori informazioni](../building-journeys/journeys-coworker-skills.md#journey-analyze)
...
* La pagina **Creare un’attività live** è stata corretta: il campo `executionMetadata` è disponibile solo per le campagne **transazionali attivate da API**, non per le campagne di marketing attivate da API come indicato in precedenza. [Ulteriori informazioni](../mobile-live/create-mobile-live.md#metadata)

* La documentazione relativa al **set di dati degli eventi di feedback dei messaggi AJO** è stata ampliata per chiarire che copre il feedback sulla consegna dei messaggi su tutti i canali (e-mail, SMS/RCS/MMS, direct mail), non solo e-mail e notifiche push; ora include anche una sezione **Classificazione delle esecuzioni di test e non di test** che spiega come interpretare il campo `isTestExecution`, inclusi i valori `NULL` o mancanti. [Ulteriori informazioni](../data/datasets-query-examples.md#classify-test-executions)

* È stata documentata una nuova funzionalità **Gestione dei contenuti** per CX Coworker, basata su 15 strumenti MCP di lettura/scrittura che consentono di individuare, creare, aggiornare, clonare e pubblicare modelli di contenuto, frammenti, pagine di destinazione e contenuti di messaggi in linea con il percorso o la campagna utilizzando prompt in linguaggio naturale. [Ulteriori informazioni](../content-management/content-management-coworker-skills.md#content-management)

* La documentazione **Aggiungere contenuto alla pagina di destinazione** descrive ora un’opzione **Rendi obbligatorio il campo modulo** per le caselle di controllo del consenso: se abilitata, il modulo non può essere inviato a meno che la casella di controllo non sia selezionata e sia applicata sia lato client che lato server. [Ulteriori informazioni](../landing-pages/lp-content.md#use-form-component)

* La pagina **Introduzione alla simulazione di percorso** è stata aggiornata per illustrare che i nodi della decisione sui contenuti e il metodo della regola di targeting dell’attività **Ottimizza** sono ora supportati nella simulazione (precedentemente indicati come critici) con una nuova tabella **Comportamento della funzione Decisioni** che descrive nei dettagli come vengono valutate l’idoneità delle offerte, le regole di idoneità, i tipi di pubblico e i metodi di ranking durante l’esecuzione di una simulazione. [Ulteriori informazioni](../building-journeys/simulate-journey-gs.md#limitations)

* La pagina **Convertire immagini in modelli di contenuto e-mail** è stata corretta per rimuovere un requisito di autorizzazioni errato: l’autorizzazione **Gestisci modelli di contenuto** non è richiesta per accedere e creare modelli con il convertitore da immagine a HTML, è necessaria solo l’autorizzazione **Genera contenuto**. [Ulteriori informazioni](../content-management/image-to-html.md#access-image-to-html)

* La pagina **Sistemi esterni (azioni personalizzate)** è stata corretta: l’interruttore di circuito per gli endpoint di azione personalizzate lente ora si attiva quando più del 20% delle chiamate in una finestra di 120 secondi supera la durata di **5 secondi** (in precedenza indicato come 10 secondi). [Ulteriori informazioni](../configuration/external-systems.md#response-time)

* La pagina **Configurare la configurazione dei canale** include ora una nota che chiarisce che lo schema utilizzato per la dimensione secondaria deve avere una chiave primaria e che le chiavi primarie composite non sono supportate. [Ulteriori informazioni](../orchestrated/channel-config.md)

* Le pagine **Dati e set di dati fedeltà** e **Introduzione alle origini** sono state aggiornate per includere LAVA come connettore fedeltà e premi supportato, insieme a Talon.One, Capillary e Kobie. [Ulteriori informazioni](../loyalty-challenges/loyalty-data-and-datasets.md)

* Le pagine **Delega un sottodominio** e **Configura sottodomini Web** sono state aggiornate per riflettere che, a seconda del contratto di licenza, ora è possibile delegare fino a 3000 sottodomini, rispetto al limite precedente di 100. [Ulteriori informazioni](../configuration/delegate-subdomain.md#guardrails)

## Agosto 2026 {#august-2026}

* La pagina **Aggiungere frammenti visivi alle e-mail** ora chiarisce che un frammento con contenuto dinamico e uno stato predefinito vuoto viene visualizzato vuoto in E-mail Designer: simula con un profilo corrispondente per visualizzare in anteprima il contenuto. [Ulteriori informazioni](../email/use-visual-fragments.md#fragment-dynamic-content)

* La pagina **Tracciare i messaggi** è stata aggiornata per chiarire che i caratteri URL non supportati (ad esempio, gli apostrofi) devono essere codificati in percentuale e che la mancata codifica può interrompere i collegamenti tracciati e i parametri di tracciamento URL. [Ulteriori informazioni](../email/message-tracking.md#insert-links)

* La pagina **Inviare utilizzando gli scaglioni** è stata aggiornata per documentare che l’ultimo scaglione in un percorso di pubblico di lettura deve essere pianificato entro **6 giorni e 18 ore** dall’inizio del percorso. Il superamento di questa finestra attiva un errore di convalida e impedisce al percorso di entrare in modalità di test o di essere pubblicato. [Ulteriori informazioni](../delivery/send-using-waves.md#limitations-guardrails)

* È stata aggiunta una nuova sezione **Eliminare eventi di feedback** alla pagina **Raccolta dati di gestione delle decisioni**, che documenta come utilizzare il flag `dryRun` per eliminare gli eventi di decisione durante il test e impedire l’acquisizione di feedback per i contatori di reporting e quota limite. [Ulteriori informazioni](../offers/data-collection/data-collection.md#suppress-feedback)

* Ora è disponibile una nuova pagina **Scegliere un metodo di convalida**. Vengono confrontati la simulazione del percorso, la modalità di test e l’esecuzione di prova del percorso, ovvero i dati utilizzati da ciascun utente, che invii messaggi reali o errori comuni da evitare, e una guida decisionale per scegliere il metodo corretto in ogni fase della creazione di un percorso. [Ulteriori informazioni](../building-journeys/choose-validation-method.md)
...
* Sono stati aggiunti video descrittivi alla documentazione sulle sfide di fedeltà per creare le sfide, configurare i fornitori di premi e monitorare le prestazioni delle sfide. [Guardare i video della sfida](../loyalty-challenges/create-challenges.md#video), [guardare il video del fornitore del premio](../loyalty-challenges/reward-definition-guide.md#video) e [guardare il video del reporting](../loyalty-challenges/loyalty-reporting.md#video).
...
* La documentazione dell’**API della migrazione della funzione Decisioni** è stata migliorata con indicazioni complete sulla migrazione degli oggetti di gestione delle decisioni nella Funzione decisioni. Le nuove sezioni includono: riferimento per la mappatura delle entità con 10 convenzioni di denominazione, distinzione tra ciò che rientra e ciò che non rientra nell’ambito, confronti dettagliati tra i modelli di richiesta/risposta, tre modelli di implementazione (lato client, lato server, ibrido) con gestione dei cookie, requisiti di tracciamento degli eventi con 5 esempi di JSON degli eventi, prerequisiti per la migrazione tra sandbox, processo di migrazione end-to-end in 5 passaggi e domande frequenti sulla migrazione. [Ulteriori informazioni](../experience-decisioning/decisioning-migration-api.md)
