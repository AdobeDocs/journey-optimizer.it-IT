...
* È stata aggiunta una nota alla sezione Creare un predefinito per moduli per specificare i requisiti per le connessioni in streaming da visualizzare nell’elenco a discesa per la selezione. [Ulteriori informazioni](../landing-pages/lp-forms.md)
