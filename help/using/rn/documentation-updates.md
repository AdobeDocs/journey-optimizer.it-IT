...
* È ora disponibile una nuova pagina per la gestione delle decisioni. Elenca tutti gli operatori, gli helper e le funzioni supportate durante la creazione di espressioni nel contenuto delle offerte, nelle regole di decisione e nelle formule di classificazione. Utilizzare questo elenco per evitare errori di runtime. Solo le funzioni documentate sono supportate dalla gestione delle decisioni. [Ulteriori informazioni](../offers/personalization-editor-supported-functions.md)
