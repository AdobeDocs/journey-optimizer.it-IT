...
* È stato introdotto un nuovo attributo `render` nell&#39;editor di personalizzazione. Impostarlo su `false` se si desidera nascondere il contenuto di un frammento di espressione. [Ulteriori informazioni](../personalization/use-expression-fragments.md#use-expression-fragment)
