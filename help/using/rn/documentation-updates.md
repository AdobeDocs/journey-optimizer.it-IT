...
* L&#39;interfaccia delle campagne ora dispone di due schede separate: **Azione** e **API Attivata**. La documentazione è stata aggiornata di conseguenza, con informazioni per ogni tipo di campagna organizzate in sezioni dedicate per migliorarne la chiarezza e l’usabilità. [Ulteriori informazioni](../campaigns/get-started-with-campaigns.md)

* Le pagine [Introduzione alla delega del sottodominio](../configuration/about-subdomain-delegation.md) e [Delega un sottodominio](../configuration/delegate-subdomain.md) sono state aggiornate per presentare meglio i diversi metodi di delega e i passaggi per configurarli.

* È stata aggiunta una nota alla sezione Frammenti, specificando che quando il tracciamento è abilitato in un percorso o in una campagna, se i collegamenti sono presenti in un frammento e se questo frammento viene utilizzato in un messaggio, questi collegamenti vengono tracciati come tutti gli altri collegamenti inclusi nel messaggio. [Ulteriori informazioni](../content-management/create-fragments.md#content)

* I guardrail e le limitazioni applicabili alla delega dei sottodomini in Journey Optimizer sono stati arricchiti e consolidati in una sezione dedicata. [Ulteriori informazioni](../configuration/delegate-subdomain.md#guardrails)

* È stata aggiunta una nota alle pagine Crea offerte di fallback e Crea decisioni per indicare che le offerte di fallback devono contenere tutte le rappresentazioni utilizzate all’interno di una decisione. [Ulteriori informazioni](../offers/offer-library/creating-fallback-offers.md)

* Le protezioni applicate ai frammenti sono state arricchite. [Ulteriori informazioni](../start/guardrails.md#fragments-guardrails).
