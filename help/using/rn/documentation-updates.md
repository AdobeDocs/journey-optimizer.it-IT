...
* È ora disponibile una nuova pagina che illustra le funzionalità decisionali di Journey Optimizer, incluse le differenze tra il framework Decisioning di nuova generazione e la soluzione di gestione delle decisioni adottata, e i principali vantaggi per la distribuzione di offerte personalizzate tra i canali. [Ulteriori informazioni](../experience-decisioning/gs-decision.md)

* È ora disponibile una nuova pagina che illustra cosa è una superficie di esperienza basata su codice, inclusi gli URI di superficie, il modo in cui le superfici funzionano come contenitori a qualsiasi livello gerarchico (pagine web, app mobili, posizioni dei contenuti) e come connettono l’implementazione delle applicazioni alla configurazione dei canali. [Ulteriori informazioni](../code-based/code-based-surface.md)

* È ora disponibile una nuova pagina su come pubblicare e gestire le esperienze basate su codice, che include l’attivazione delle campagne, il monitoraggio della distribuzione, l’apporto di modifiche e l’arresto delle campagne. [Ulteriori informazioni](../code-based/publish-code-based.md)

* È ora disponibile una nuova pagina sui test delle esperienze basate su codice, che illustra come visualizzare in anteprima i contenuti con i profili di test, convalidare l’implementazione utilizzando gli strumenti di sviluppo del browser o gli strumenti di debug per dispositivi mobili e verificare che il contenuto venga visualizzato correttamente prima della pubblicazione. [Ulteriori informazioni](../code-based/test-code-based.md)
...
* È ora disponibile una nuova pagina nella sezione Experience Decisioning su come configurare la raccolta dati per il tracciamento di impression, clic ed eventi personalizzati. [Ulteriori informazioni](../experience-decisioning/data-collection/schema-requirement.md)
...
* È stata aggiunta una nuova pagina che descrive come utilizzare i criteri di consenso per tenere conto delle preferenze cliente in base alle relative scelte, rispettandone al contempo il consenso. [Ulteriori informazioni](../action/preference-center.md)
