...
* [!BADGE Obsolescenza]{type=Negative} I tipi di pubblico batch non sono più supportati nel nodo Qualificazione del pubblico. A partire dal 3 agosto 2026, Journey Optimizer blocca la pubblicazione per qualsiasi percorso utilizzando un pubblico batch in un nodo Qualificazione del pubblico. Questa applicazione sostituisce l’avviso canvas introdotto nella versione di giugno. I percorsi live esistenti non vengono interessati. Utilizza un pubblico in streaming nel nodo Qualificazione del pubblico o passa a un’attività Read Audience. [Scopri come eseguire la migrazione dei percorsi](../building-journeys/aq-batch-audiences-migration.md)
