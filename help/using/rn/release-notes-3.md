...
<!-- DRAFT v3 — Same topic-based grouping as release-notes-2.md. Variation: Coming soon entries use an accordion (+++) instead of an H4 subsection. -->
...
Le seguenti funzionalità di percorso sono previste nei prossimi giorni o settimane.
...
La seguente funzionalità di campagna orchestrata è prevista nei prossimi giorni o settimane.
...
I seguenti miglioramenti della campagna sono attesi nei prossimi giorni o settimane.
...
La funzionalità Decisioning seguente è prevista per i prossimi giorni o settimane.
...
I seguenti miglioramenti della somministrazione sono attesi nei prossimi giorni o settimane.
...
Nei prossimi giorni o settimane sono previsti i seguenti miglioramenti per quanto riguarda la generazione di rapporti.
