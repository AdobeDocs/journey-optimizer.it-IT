...
* Ora puoi eseguire il targeting di tipi di pubblico caricati da un file CSV in percorsi e campagne. [Ulteriori informazioni](../audience/about-audiences.md#about-segments)
...
<tr>
<td>
<p>È ora possibile creare flussi di lavoro di composizione per combinare i tipi di pubblico esistenti di Adobe Experience Platform in un’area di lavoro visiva e sfruttare diverse attività (suddivisione, arricchimento...) per creare nuovi tipi di pubblico. I tipi di pubblico appena creati vengono salvati nuovamente in Adobe Experience Platform insieme a quelli esistenti e possono essere utilizzati nelle campagne di Journey Optimizer per il targeting dei clienti.</p>
...
<thead>
<tr>
<th><strong>Modello di ranking IA per l’ottimizzazione personalizzata (disponibilità generale)</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>I modelli di ranking IA per l’ottimizzazione personalizzata sono ora disponibili in Gestione decisioni. Questo nuovo tipo di modello consente di ottimizzare e personalizzare le offerte in base alle loro prestazioni e ai tipi di pubblico.</p>
...
<tr>
<td>
<p>Adobe Experience Platform offre una suite di funzionalità per l’igiene dei dati che ti consentono di gestire i dati archiviati tramite le eliminazioni programmatiche di record e set di dati dei consumatori. Questa funzionalità è ora disponibile per Adobe Journey Optimizer. </p>
...
* Una nuova sottosezione fornisce consigli sulla creazione dell’indirizzo **Rispondi a (e-mail)** per garantire una corretta gestione delle risposte. [Ulteriori informazioni](../email/email-settings.md#send-to-suppressed-email-addresses)
...
* Dopo aver selezionato un pool IP in una configurazione dei canali, le informazioni del record PTR sono ora visibili quando si passa il puntatore sugli indirizzi IP. [Ulteriori informazioni](../email/email-settings.md#ip-pools)
