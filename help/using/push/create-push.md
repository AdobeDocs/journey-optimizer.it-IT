...
## Creare una notifica push in un percorso o in una campagna {#create}
...
1. Dalla schermata di configurazione del percorso, fai clic su **[!UICONTROL Edit content]** per configurare il contenuto push. [Progettazione di una notifica push](design-push.md)
...
1. Quando il push è pronto, completa la configurazione del tuo [viaggio](../building-journeys/journey-gs.md) per inviarlo.
...
1. Crea una nuova campagna pianificata o attivata dall’API, seleziona **[!UICONTROL Push notification]** come azione e scegli la **[!UICONTROL App surface]** da utilizzare. [Ulteriori informazioni sulla configurazione push](push-configuration.md).
...
1. Da **[!UICONTROL Action triggers]** scegliere il menu **[!UICONTROL Frequency]** della notifica push:
...
1. Dalla schermata di configurazione della campagna, fai clic su **[!UICONTROL Edit content]** per configurare il contenuto push. [Progettazione di una notifica push](design-push.md)
...
Per ulteriori informazioni sulle prestazioni quando si utilizza la modalità di consegna rapida, consulta [Descrizione del prodotto Adobe Journey Optimizer](https://helpx.adobe.com/legal/product-descriptions/adobe-journey-optimizer.html).

### Prerequisiti {#prerequisites}

I messaggi di consegna rapida sono forniti con i seguenti requisiti:

* La consegna rapida è disponibile per **[!UICONTROL Scheduled]** solo per le campagne e non è disponibile per le campagne con attivazione API,
...
1. Creare una campagna di notifica push e attivare **[!UICONTROL Rapid delivery]** opzione .
