...
**In questa pagina:** scopri come importare un pubblico da un file CSV utilizzando il portale dell&#39;audience di Adobe Experience Platform e mappare il suo attributo di identità ai profili dei clienti.
...
>[!NOTE]
>
>Per i tipi di pubblico di caricamento personalizzati (caricamento CSV) e per altri tipi di pubblico esterni, al momento **[!UICONTROL Lettura incrementale]** non è supportata dal punto di vista funzionale. A ogni ricorrenza, viene recuperato l&#39;**intero pubblico**, indipendentemente dall&#39;impostazione Incremental read toggle.
