...
**In questa pagina:** scopri come utilizzare la sintassi di iterazione Handlebars per eseguire il loop su array da origini dati contestuali, come eventi, risposte ad azioni personalizzate e ricerche di set di dati per visualizzare elenchi dinamici nei messaggi.
...
* **Raccolte di arricchimento delle campagne orchestrate** (solo campagne orchestrate): vedi [Aggiungere personalizzazione nelle campagne orchestrate](../orchestrated/add-personalization.md#enrichment-collections).
...
* **[Attributi di destinazione](../orchestrated/add-personalization.md#attributes)** (solo campagne orchestrate): attributi calcolati nell&#39;area di lavoro della campagna, inclusi gli array di raccolta di arricchimento
...
**Caso d&#39;uso**: invia una matrice completa di oggetti nel corpo di una richiesta (per POST o GET con il corpo).
...
{{$include /help/_includes/do-not-localize/personalization/ai-augmented-iterate-contextual-data.md}}
