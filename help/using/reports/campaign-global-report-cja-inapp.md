...
**In questa pagina:** scopri come leggere il report delle campagne in-app in Adobe Journey Optimizer per analizzare le tendenze di visualizzazione e clic, i dati di tracciamento e i collegamenti tracciati per i messaggi in-app.
