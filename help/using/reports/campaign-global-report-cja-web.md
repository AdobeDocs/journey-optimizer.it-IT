...
# Rapporto sulla campagna web {#campaign-global-report-cja-web}

>[!BEGINSHADEBOX]

**In questa pagina:** Scopri come leggere il report della campagna Web in Adobe Journey Optimizer per analizzare le tendenze di impression e clic, i dati di tracciamento e i collegamenti tracciati per le tue pagine Web.

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

Per accedere al report della campagna Web, fai clic sul pulsante **[!UICONTROL Report]** nella campagna e seleziona **[!UICONTROL Visualizza report completo]**. [Ulteriori informazioni](report-gs-cja.md)
