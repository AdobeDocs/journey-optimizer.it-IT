...
**In questa pagina:** Trova le definizioni per le metriche utilizzate nei report di Adobe Journey Optimizer per i diversi tipi di consegna, tra cui percorso, e-mail, SMS, push, in-app, pagina di destinazione, direct mailing, scheda di contenuto, web e metriche di esperienza basate su codice.
