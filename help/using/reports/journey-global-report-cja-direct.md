...
description: Scopri come utilizzare i dati diretti dal rapporto sul percorso
...
# Rapporto sul percorso direct mail {#journey-global-report}

>[!BEGINSHADEBOX]

**In questa pagina:** Scopri come leggere le metriche della direct mailing nel rapporto di percorso, incluse le statistiche di invio, lo stato di consegna, i motivi di errore e i motivi di esclusione per i messaggi di direct mailing.

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

Puoi accedere al report del percorso di direct mailing facendo clic sul pulsante **[!UICONTROL Visualizza report]** all&#39;interno del percorso. [Ulteriori informazioni](report-gs-cja.md)
