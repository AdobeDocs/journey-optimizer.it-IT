...
**In questa pagina:** Aggiungi un&#39;azione LINE a un percorso o a una campagna e crea contenuti personalizzati, dal testo e gli adesivi alle immagini, ai video, alle posizioni e ai messaggi di Flex, in modo da coinvolgere i clienti su LINE.

>[!ENDSHADEBOX]

## Aggiungere un messaggio LINE {#create-line-journey-campaign}

>[!CONTEXTUALHELP]
>id="ajo_journey_action_line"
>title="Azione LINE"
>abstract="Un’azione di canale LINE invia un messaggio LINE ai profili quando raggiungono questo passaggio del percorso. L’etichetta identifica l’attività nell’area di lavoro del percorso e l’azione fa riferimento a una configurazione LINE che definisce il contenuto consegnato. La sezione **Ottimizzazione** può includere esperimenti di contenuto o regole di targeting, la sezione **Multilingue** può distribuire contenuto in più lingue e la sezione **Timeout o errore** può definire un percorso alternativo se l’azione non riesce."
...
1. Nella sezione **[!UICONTROL Tracciamento azioni]**, specifica se desideri tenere traccia dei clic sui collegamenti nel messaggio LINE.
...
1. Dal menu **[!UICONTROL Trigger azione]**, scegli la **[!UICONTROL Frequenza]** del messaggio LINE:
...
1. Dalla schermata di configurazione del percorso o della campagna, fai clic sul pulsante **[!UICONTROL Modifica contenuto]** per configurare il contenuto del messaggio LINE.
