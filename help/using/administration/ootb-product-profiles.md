...
|Messaggi| <ul><li>**[!DNL Manage messages]**: leggere, creare, modificare ed eliminare messaggi e pagine di destinazione.</li><li>**[!DNL Publish messages]** pubblicare messaggi e pagine di destinazione.</li><li>**[!DNL Manage messages preview and test]**: leggi, crea e modifica l’anteprima di messaggi/pagine di destinazione e invia test/proof.</li><li>**[!DNL View messages report]**: leggi e modifica i rapporti sui messaggi e sulle pagine di destinazione.</li></ul>|
...
|Messaggi| <ul><li>**[!DNL Manage messages]**: leggere, creare, modificare ed eliminare messaggi e pagine di destinazione.</li><li> **[!DNL Manage messages preview and test]**: leggi, crea e modifica l’anteprima di messaggi/pagine di destinazione e invia test/proof.</li><li>**[!DNL View messages report]**: leggi e modifica i rapporti sui messaggi e sulle pagine di destinazione.</li></ul>|
|Gestione delle decisioni| <ul><li>**[!DNL Manage decisions]**: leggere, creare, modificare ed eliminare le entità decisionali.</li><li>**[!DNL Manage ranking strategies]**: leggere, creare, modificare ed eliminare i rapporti sui messaggi personalizzati e utilizzare le funzionalità di azione.</li></ul>| |Adobe Experience Platform| <ul><li> **[!DNL Manage segments]**: leggere, creare, modificare ed eliminare segmenti ed elenchi di sottoscrizioni.</li><li>**[!DNL Manage profiles]**: leggere, creare, modificare ed eliminare i profili.</li><li>**[!DNL Read datasets]**: accesso in sola lettura ai set di dati.</li><li>**[!DNL Read schemas]**: accesso in sola lettura agli schemi.</li><li>**[!DNL Manage merge policies]**: leggere, creare, modificare ed eliminare i criteri di unione.</li></ul>|
|Amministrazione| <ul><li>**[!DNL View messages presets]**: accesso in sola lettura ai predefiniti per messaggi.</li></ul>|
...
|Messaggi| <ul><li>**[!DNL View messages]**: accesso in sola lettura ai messaggi e alle pagine di destinazione.</li><li>**[!DNL View messages report]**: accesso in sola lettura ai rapporti sui messaggi e sulle pagine di destinazione.</li></ul>|
