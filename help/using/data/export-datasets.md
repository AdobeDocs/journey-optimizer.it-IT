...
**In questa pagina:** configura connessioni live alle destinazioni di archiviazione cloud in modo da poter esportare i set di dati di Journey Optimizer per il reporting, l&#39;archiviazione e l&#39;analisi dei dati esterni.
...
* [Blob Azure](https://experienceleague.adobe.com/docs/experience-platform/destinations/catalog/cloud-storage/azure-blob.html?lang=it){target="_blank"}
