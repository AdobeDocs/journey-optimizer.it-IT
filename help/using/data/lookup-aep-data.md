...
**In questa pagina:** abilita i set di dati Adobe Experience Platform basati su record per la ricerca in modo da arricchire la personalizzazione, il decisioning e l&#39;orchestrazione del percorso con i dati di riferimento e transazionali recuperati in fase di esecuzione in Journey Optimizer.
...
>[!NOTE]
>
>La funzionalità di ricerca dati è disponibile in Disponibilità limitata ed è disponibile per tutti i clienti Journey Optimizer.
