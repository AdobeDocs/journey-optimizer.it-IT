...
description: Scopri come eseguire la migrazione di percorsi che utilizzano tipi di pubblico in batch in un nodo di qualificazione del pubblico prima della data di applicazione.
...
# Migrare i tipi di pubblico in batch dai percorsi di qualificazione del pubblico e dai criteri di uscita{#aq-batch-migration}

A partire da settembre 2026, Journey Optimizer bloccherà la pubblicazione per i percorsi che utilizzano un pubblico batch in un nodo di qualificazione del pubblico o in Criteri di uscita. Identifica il tuo caso d’uso e segui il percorso di migrazione consigliato.

>[!CAUTION]
>
>**Data di applicazione: settembre 2026.** I percorsi nuovi, in bozza e duplicati che utilizzano un pubblico batch in un nodo di qualificazione del pubblico o in Criteri di uscita non possono essere pubblicati dopo questa data. Un avviso di convalida è già stato visualizzato nell’area di lavoro del percorso a partire dalla versione di giugno 2026.
...
**[I criteri di uscita](journey-properties.md#exit-criteria)** si basano sullo stesso meccanismo di **[!UICONTROL Qualificazione del pubblico]** del nodo di ingresso, pertanto sono soggetti alle stesse limitazioni. In futuro, utilizza un pubblico in streaming durante la configurazione di **[!UICONTROL Exit Criteria]**.

## Effetti sui percorsi {#impact}

Un percorso live che utilizza un pubblico batch in un nodo di qualificazione del pubblico o in un criterio di uscita continua a essere eseguito dopo settembre 2026. Tuttavia, se interrompi, duplichi o ripubblichi il percorso, questo verrà bloccato fino a quando la configurazione non viene aggiornata.


| Stato del percorso | Impatto dopo settembre 2026 |
| --- | --- |
