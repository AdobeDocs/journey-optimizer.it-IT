...
**In questa pagina:** Trova le risposte alle domande più frequenti su Journey Orchestration in Adobe Journey Optimizer, relative a concetti generali, attività, eventi e risoluzione dei problemi.
...
Consulta [Scegli come testare e convalidare il tuo percorso](choose-validation-method.md) per un confronto completo o scopri di più sulla [simulazione](simulate-journey-gs.md), sulla [modalità di test](testing-the-journey.md) e sulla [esecuzione inattiva](journey-dry-run.md).
...
Ulteriori informazioni su [condizioni](conditions.md), [azioni messaggio](journey-action.md) e [selezione canale](../channels/gs-channels.md).
