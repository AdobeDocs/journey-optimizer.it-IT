...
source-git-commit: 6cae9757ae58f809461b944a886b497a73c796f4
workflow-type: tm+mt
...
| Origini dati esterne | Le chiamate vengono eseguite durante la simulazione nello stesso modo in cui vengono eseguite in un percorso live. Le attività a valle possono utilizzare la risposta, ma non puoi prenderla in giro. Quando un valore di risposta genera un&#39;attività **[!UICONTROL Ottimizza]**, AI non può inventare tale output. Genera solo input per la chiamata. Ad esempio, se una chiamata accetta una città profilo e restituisce il meteo, l’agente imposta una città sull’utente simulato e la chiamata in tempo reale restituisce il meteo. |
| Azioni personalizzate | Il comportamento corrisponde alle origini dati esterne. Le chiamate in uscita vengono eseguite in tempo reale. L’intelligenza artificiale inserisce gli input. Gli output provengono dalla risposta live. Non puoi prendere in giro le risposte. |
...
| Numero massimo di utenti simulati per richiesta di generazione | 50 | Numero massimo di utenti simulati generati da IA in una richiesta tramite **[!UICONTROL Simulazione rapida]** o **[!UICONTROL Generazione con IA]** in **[!UICONTROL Simulazione manuale]**. Se il percorso ha più di **50** percorsi, AI seleziona in modo casuale i percorsi per produrre questi **50** utenti simulati. |
...
| Fidelizzazione utenti simulata generata da IA | 10 giorni | Gli utenti simulati generati dall’intelligenza artificiale vengono eliminati automaticamente 10 giorni dopo la creazione. |
