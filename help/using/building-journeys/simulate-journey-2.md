...
1. Per iniziare, compila l&#39;elenco **[!UICONTROL Utenti test]**:
   ...
   Per i percorsi con un nodo E-mail o SMS, l’IA richiede di confermare l’indirizzo e-mail o il numero di telefono da utilizzare. Gli utenti simulati verranno generati utilizzando tali valori definiti. Al termine, fai clic su **[!UICONTROL Genera]**.
...
Seleziona **[!UICONTROL Tutti]** per visualizzare i risultati aggregati per ogni utente simulato nell&#39;esecuzione. Questa visualizzazione consente di esaminare a colpo d’occhio l’intera simulazione, incluse attività, risultati ed errori, senza scegliere prima un singolo utente simulato.
