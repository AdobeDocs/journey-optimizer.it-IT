...
I profili di test sono necessari quando si utilizza il [modalità di prova](../building-journeys/testing-the-journey.md) in un percorso e [visualizzare in anteprima e testare il contenuto](../messages/preview.md).
...
Un modo semplice per farlo è utilizzare un **[!UICONTROL Update Profile]** attività di azione in un percorso e modifica **testProfile** campo booleano da false a true.
