...
Per esportare l’elenco di soppressione come file CSV, seleziona il **[!UICONTROL Scarica CSV]** pulsante .
...
1. Scarica il modello CSV da utilizzare, che include le colonne e il formato seguenti:
   ...
   Puoi anche scaricare questo modello dal **[!UICONTROL Elenco di eliminazione]** vista principale.
