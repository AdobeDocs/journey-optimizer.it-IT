...
La creazione di un sottodominio per le campagne e-mail consente ai brand di isolare diversi tipi di traffico (marketing e aziende, ad esempio) in pool IP specifici e con domini specifici, velocizzando il processo di riscaldamento dell’IP e migliorando il recapito messaggi in generale. Se condividi un dominio e questo viene bloccato o aggiunto all’elenco non consentiti, potrebbe avere un impatto sulla consegna della posta aziendale. Tuttavia, problemi o blocchi di reputazione su un dominio specifico per le tue comunicazioni di marketing e-mail avranno un impatto solo su quel flusso di e-mail. L’utilizzo del dominio principale come mittente o indirizzo &quot;Da&quot; per più flussi di posta potrebbe anche interrompere l’autenticazione delle e-mail, bloccando o inserendo i messaggi nella cartella spam.
...
Prendiamo ad esempio il dominio &quot;mybrand.com&quot;, utilizzato per inviare comunicazioni transazionali e di marketing. In questa situazione, puoi decidere di impostare due sottodomini:
...
In questo modo potrai preservare la reputazione del tuo dominio e di altri sottodomini. Ad esempio, se i sottodomini &quot;marketing.mybrand.com&quot; finissero per essere aggiunti all’elenco Bloccati dai provider di servizi Internet a causa di un recapito non riuscito, questo impedirebbe l’aggiunta all’elenco Bloccati dell’intero dominio &quot;mybrand.com&quot; e del sottodominio &quot;info.mybrand.com&quot;.
...
* **Utilizzo dei CNAME**: Crea un sottodominio e utilizza i CNAME per puntare a record specifici di Adobe. Utilizzando questa configurazione, tu e Adobe condividete la responsabilità di mantenere il DNS. [Ulteriori informazioni sulla delega dei sottodomini CNAME](delegate-subdomain.md#cname-subdomain-delegation)
...
La tabella seguente fornisce un riepilogo del funzionamento di questi metodi, nonché del relativo livello di impegno:

| Metodo di configurazione | Come funziona | Livello di sforzo |
|---|---|---|
| **Delega completa** | Crea il record del sottodominio e dello spazio dei nomi. Adobe configurerà quindi tutti i record DNS richiesti per Adobe Campaign.<br/><br/>In questa configurazione, Adobe è completamente responsabile della gestione del sottodominio e di tutti i record DNS. | Basso |
...
Se hai domande sui metodi di configurazione dei sottodomini, contatta Adobe o contatta l’Assistenza clienti per richiedere consulenza sul recapito messaggi.
...
Per accedere a informazioni dettagliate su un sottodominio con **[!UICONTROL Success]** , aprilo dall&#39;elenco.
