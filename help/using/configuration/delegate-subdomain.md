...
>[!NOTE]
>
>Questa sezione descrive come impostare un sottodominio utilizzando i metodi di delega completa o CNAME. Il metodo di delega personalizzata è descritto in [questa sezione](#setup-custom-subdomain).
