...
>abstract="Journey Optimizer consente di delegare i sottodomini ad Adobe. Puoi delegare completamente un sottodominio ad Adobe, che è il metodo consigliato. Puoi anche creare un sottodominio utilizzando i CNAME per puntare a record specifici di un Adobe, ma questo approccio richiede di gestire e mantenere i record DNS autonomamente."
...
>[!NOTE]
>
>Per impostazione predefinita, [!DNL Journey Optimizer] il contratto di licenza ti consente di delegare fino a 10 sottodomini. Per aumentare questo limite, rivolgiti al tuo contatto Adobe.
...
1. Specifica il nome del sottodominio da delegare.
   ...
   >
   >I sottodomini a più livelli come email.marketing.yourcompany.com non sono attualmente supportati.
