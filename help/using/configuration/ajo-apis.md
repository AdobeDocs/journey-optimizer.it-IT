...
**In questa pagina:** Scopri come accedere, autenticare e utilizzare le API RESTful di Adobe Journey Optimizer, incluse le API di gestione delle decisioni e di Experience Decisioning, per eseguire le operazioni chiave a livello di programmazione.
...
* [Riferimento API di Adobe Journey Optimizer](https://developer.adobe.com/journey-optimizer-apis){target="_blank"}
...
* [API di Adobe Experience Platform](https://developer.adobe.com/experience-platform-apis){target="_blank"}
