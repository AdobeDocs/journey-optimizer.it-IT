...
subfeature_v2: id: c343082f-e963-4f57-a96b-b64d27f8118eid: e30b0a1a-b594-47b8-af94-1e3a2be6df11id: b3a93754-a8b8-46eb-9421-7eccaeeb3dff
...
**In questa pagina:** Scopri come creare e attivare campagne e-mail dedicate al riscaldamento IP in modo che possano essere pianificate e utilizzate all&#39;interno di un piano di riscaldamento IP.
...
1. Completa i passaggi per creare una campagna e-mail, ad esempio definendo le proprietà della campagna, [pubblico](../audience/about-audiences.md)<!--best practices for IP warmup in terms of audience?--> e [contenuto](../email/get-started-email-design.md#key-steps).
   ...
   >* [Tipi di pubblico di Data Distiller](https://experienceleague.adobe.com/en/docs/experience-platform/query/data-distiller-audiences/overview){target="_blank"} (tipi di pubblico generati utilizzando query SQL)
