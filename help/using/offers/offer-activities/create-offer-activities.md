...
1. Per assegnare etichette di utilizzo dati personalizzate o di base alla decisione, seleziona **[!UICONTROL Manage access]**. [Ulteriori informazioni su Object Level Access Control (OLAC)](../../administration/object-based-access.md)
...
1. Utilizza la **[!UICONTROL Eligibility]** per limitare la selezione delle offerte per questo posizionamento.
   ...
   * Per limitare la selezione delle offerte ai membri di un segmento Experience Platform, seleziona **[!UICONTROL Segments]**, quindi fai clic su **[!UICONTROL Add segments]**.
