...
# Consegnare offerte tramite l’API Decisioni {#deliver-offers-using-decisions-api}
...
Puoi creare e consegnare offerte effettuando una richiesta POST al [!DNL Decisions] API.
