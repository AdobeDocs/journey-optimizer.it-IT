...
Per cercare decisioni specifiche, eseguire una richiesta GET all&#39;API [!DNL Offer Library] che includa le decisioni `@id` o il nome della decisione nel percorso della richiesta.
