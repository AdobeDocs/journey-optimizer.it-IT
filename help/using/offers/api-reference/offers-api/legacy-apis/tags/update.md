...
Parametro | | Descrizione | Esempio | | `{ENDPOINT_PATH}` | Percorso dell’endpoint per le API dell’archivio. | `https://platform.adobe.io/data/core/xcore/` | | `{CONTAINER_ID}` | Contenitore in cui si trovano i tag. | `e0bd8463-0913-4ca1-bd84-6309134ca1f6` | | `{INSTANCE_ID}` | L’ID istanza del tag che desideri aggiornare. | `d48fd160-13dc-11eb-bc55-c11be7252432` |
