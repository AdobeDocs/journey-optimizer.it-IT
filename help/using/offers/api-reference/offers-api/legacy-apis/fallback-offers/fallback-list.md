...
È possibile visualizzare un elenco di tutte le offerte di fallback all&#39;interno di un contenitore eseguendo una singola richiesta GET all&#39;API [!DNL Offer Library].
