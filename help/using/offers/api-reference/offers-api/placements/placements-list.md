...
Puoi visualizzare un elenco di tutti i posizionamenti all’interno di un contenitore effettuando una singola richiesta GET all’ API [!DNL Offer Library] .
