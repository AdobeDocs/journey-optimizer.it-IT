...
Le regole di decisione sono vincoli aggiunti a un’offerta personalizzata e applicati a un profilo per determinare l’idoneità. Per visualizzare un elenco delle regole di decisione esistenti, devi eseguire una singola richiesta di GET al [!DNL Offer Library] API.
