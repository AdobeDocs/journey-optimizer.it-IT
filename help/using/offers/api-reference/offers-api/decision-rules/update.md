...
# Aggiornare una regola decisionale {#update-decision-rule}

Puoi modificare o aggiornare le regole decisionali nel contenitore effettuando una richiesta PATCH al [!DNL Offer Library] API.
