...
Per cercare una regola di decisione specifica, devi effettuare una richiesta GET al [!DNL Offer Library] API che include la regola di decisione `id` nel percorso della richiesta.
