...
Una risposta corretta restituisce i dettagli del posizionamento, incluse informazioni sull’ID contenitore, l’ID istanza e l’offerta di fallback univoca `@id`.
