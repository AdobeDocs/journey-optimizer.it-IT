...
Puoi visualizzare un elenco di tutte le offerte di fallback all’interno di un contenitore eseguendo una singola richiesta di GET all’ API [!DNL Offer Library] .
