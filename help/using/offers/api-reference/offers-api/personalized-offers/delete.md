...
# Eliminare un’offerta personalizzata

A volte può essere necessario rimuovere (DELETE) un’offerta personalizzata. È possibile eliminare solo le offerte personalizzate create nel contenitore tenant. A tal fine, esegui una richiesta DELETE all’ API [!DNL Offer Library] utilizzando l’ID $ dell’offerta personalizzata che desideri eliminare.
