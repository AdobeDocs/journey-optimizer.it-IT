...
Puoi visualizzare un elenco di tutte le offerte personalizzate all’interno di un contenitore eseguendo una singola richiesta GET al [!DNL Offer Library] API.
