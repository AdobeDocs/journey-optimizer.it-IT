...
Puoi anche inserire un frammento di contenuto Adobe Experience Manager direttamente nell&#39;offerta facendo clic su **[!UICONTROL Frammento di contenuto]**. Per accedere al frammento di contenuto nelle offerte, il posizionamento selezionato deve essere di tipo JSON.
Ulteriori informazioni sull&#39;integrazione di [Frammenti di contenuto con Journey Optimizer](../../integrations/aem-fragments.md).
