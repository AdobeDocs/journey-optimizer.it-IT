...
>abstract="Per evitare di sollecitare eccessivamente la clientela, utilizza una limitazione per definire il numero massimo di volte in cui può essere presentata un’offerta. Puoi creare fino a 10 regole di limite per una determinata offerta."
>additional-url="https://experienceleague.adobe.com/it/docs/journey-optimizer/using/decisioning/offer-decisioning/managing-offers-in-the-offer-library/configure-offers/add-constraints#capping" text="La modifica delle date può influire sui limiti"
