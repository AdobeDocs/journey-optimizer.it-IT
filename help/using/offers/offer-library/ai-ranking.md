...
### Frequenza di riqualificazione

Abbiamo eseguito diversi test statistici per prendere una decisione basata sui dati su come trovare un valore solido per la frequenza di riqualificazione e l&#39;intervallo di look-back per l&#39;ottimizzazione automatica. Nell’implementazione iniziale del servizio di classificazione, viene utilizzato un intervallo di look-back di 15 giorni e una frequenza di riqualificazione di 2 ore per costruire il modello di campionamento di Thompson.
