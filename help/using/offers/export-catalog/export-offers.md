...
Elenco di tutti i campi che possono essere utilizzati nella **[!UICONTROL Archivio oggetti decisionali - Offerte personalizzate]** set di dati.
...
**Campo:** tag
**Titolo:** Tag
**Descrizione:** Il set di qualificatori di raccolta (noti in precedenza come &quot;tag&quot;) associati a questa entità. I qualificatori della raccolta vengono utilizzati nelle espressioni filtro per vincolare l’inventario complessivo a un sottoinsieme (categoria).
**Tipo:** array
