...
* **optionSelection**
   ...
   **Descrizione:** la selezione di opzioni definisce la validità/applicabilità delle opzioni in questo contesto.
   **Tipo:** oggetto
   ...
   * **Tipo di vincolo del profilo**
      ...
      **Tipo:** stringa
      **Valori possibili:** &quot;directList&quot;, &quot;filter&quot;
...
**Description:** Decisioni relative alla data e all’ora di fine. La proprietà ha la semantica della proprietà &#39;endTime&#39; di schema.org definita su http://schema.org/Action.
**Tipo:** stringa
...
**Descrizione:** nome della decisione visualizzato in varie interfacce utente.
**Tipo:** stringa
...
**Description:** Decision start date and end time. La proprietà ha la semantica della proprietà &#39;startTime&#39; di schema.org definita su http://schema.org/Action.
**Tipo:** stringa
...
**Descrizione:** La revisione in cui si trovava l&#39;oggetto decisionale al momento dell&#39;istantanea.
**Tipo:** stringa
