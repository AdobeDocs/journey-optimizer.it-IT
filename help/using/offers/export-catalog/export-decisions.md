...
Elenco di tutti i campi che possono essere utilizzati nella **[!UICONTROL Archivio oggetti decisionali - Decisioni]** set di dati (precedentemente noto come archivio oggetti decisionali - Attività).
...
+++_experience > decisionale > criteri > optionSelection
...
* Filtro opzione
   ...
   **Descrizione:** Il riferimento a un filtro basato su un qualificatore di raccolta (noto in precedenza come &quot;tag&quot;) che corrisponde alle opzioni di un inventario utilizzando i relativi qualificatori di raccolta allegati. Il valore è l&#39;URI (@id) della regola decisionale a cui si fa riferimento. Vedi schema https://ns.adobe.com/experience/decisioning/filter.
   **Tipo:** stringa
...
+++_experience > decisionale > criteri > profileConstraints > Descrizione
...
+++_experience > decisionale > criteri > classificazione > ordine
...
+++_experience > decisionale > Data e ora di inizio attività
