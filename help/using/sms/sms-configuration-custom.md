...
1. Fai clic su ![](assets/do-not-localize/Smock_Add_18_N.svg) per aggiungere le categorie delle parole chiave, quindi configurale come segue:
   ...
   * **[!UICONTROL Inserisci una parola chiave]**: immetti le parole chiave predefinite o personalizzate che attiveranno automaticamente il messaggio. Per più parole chiave, utilizza valori separati da virgola.

   * **[!UICONTROL Messaggio di risposta]**: immettere la risposta personalizzata inviata automaticamente.

   ![](assets/sms_byo_6.png)

1. Abilita l&#39;opzione **[!UICONTROL Rinuncia fuzzy]** per rilevare messaggi simili alle parole chiave di rinuncia (ad esempio, &#39;CANCIL&#39;).
