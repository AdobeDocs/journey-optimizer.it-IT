...
![Notifica richiesta di approvazione](assets/request-notification.png)
...
![Finestra di dialogo per approvare la richiesta](assets/approve-request.png)

## Richiedi modifiche a un percorso/campagna {#changes}

Se sono necessarie modifiche in un percorso o in una campagna che è stata inviata per l’approvazione, puoi inviare una richiesta all’autore in modo che apporti le modifiche necessarie.

A tale scopo, fare clic sul pulsante **[!UICONTROL Richiedi modifiche]**. Nel riquadro visualizzato, fornisci un messaggio con i dettagli della richiesta e fai clic su **[!UICONTROL Invia]** per inviare la richiesta.

![Finestra di dialogo Modifiche richiesta](assets/request-changes.png)

Dopo aver inviato la richiesta, il creatore del percorso/campagna riceve una notifica tramite e-mail e un avviso Journey Optimizer. La campagna ritorna allo stato &quot;Bozza&quot;. Una volta integrate le modifiche, il creatore del percorso o della campagna può inviarle nuovamente per l’approvazione.
