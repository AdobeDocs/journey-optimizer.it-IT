...
* **Numero di varianti** - È possibile aggiungere fino a 30 varianti per testare il contenuto quando vengono aggiunte utilizzando un file o manualmente. Quando si utilizza la generazione automatica dell’intelligenza artificiale, il sistema determina quante varianti creare in base al contenuto (campi di personalizzazione e rami condizionali), fino a un massimo di 40 varianti.
...
[!DNL Journey Optimizer] può utilizzare la simulazione basata sull&#39;intelligenza artificiale per generare automaticamente varianti di contenuto in modo da poter convalidare la logica di personalizzazione senza creare varianti manualmente. Il sistema analizza i contenuti, identifica i campi di personalizzazione e i rami condizionali e crea tutte le varianti necessarie per includerli con valori significativi per un’anteprima quasi realistica.

Per generare automaticamente le varianti, fare clic sul pulsante **[!UICONTROL Genera]** e attendere che il sistema completi la generazione. Esamina le varianti generate nell’elenco delle varianti e il relativo rendering nel riquadro di anteprima.

![Pulsante Genera varianti](assets/simulate-variants-generate.png)

>[!NOTE]
>
>Il numero di varianti create dipende dal contenuto. I messaggi con una semplice personalizzazione possono produrre una singola variante, mentre i contenuti con più rami condizionali possono produrre diverse varianti. Facendo clic su **[!UICONTROL Genera]**, tutte le varianti di contenuto esistenti nell&#39;elenco, comprese quelle aggiunte manualmente o da un file, vengono sostituite con le varianti generate da IA.
