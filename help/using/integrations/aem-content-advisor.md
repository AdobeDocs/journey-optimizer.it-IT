...
**In questa pagina:** scopri come accedere e utilizzare Adobe Experience Manager Content Advisor per individuare risorse, elementi multimediali dinamici e frammenti di contenuto tramite la ricerca semantica basata sull&#39;intelligenza artificiale direttamente nei flussi di lavoro di authoring di Journey Optimizer.
...
1. Nell&#39;editor di Personalization, scegliere il punto di ingresso del contenuto:
   ...
   * Per aggiungere una risorsa, fare clic su **[!UICONTROL Assets]** e quindi su **[!UICONTROL Apri AEM Content Advisor]**.

     ![](assets/content-advisor-11.png){zoomable="yes"}

   * Per aggiungere un frammento di contenuto Adobe Experience Manager, fare clic su **[!UICONTROL Frammento di contenuto AEM]** e quindi su **[!UICONTROL Apri AEM Content Advisor]**.
