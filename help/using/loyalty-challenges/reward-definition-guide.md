...
>title="Guida alla definizione del premio"
>abstract="Utilizza questa guida per configurare le definizioni dei premi per i provider di premi fedeltà, inclusi i campi payload di tipo Comportamento definizione predefinito e Evasione."
