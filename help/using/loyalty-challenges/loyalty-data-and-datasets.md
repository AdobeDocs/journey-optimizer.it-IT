...
**In questa pagina:** scopri quali identità, profili, eventi, tipi di pubblico e set di dati di Adobe Experience Platform supportano le sfide di fidelizzazione e in che modo il time-to-live dei set di dati influisce sulla conservazione dei dati.
