...
* **[!UICONTROL Sfida]**: nome assegnato alla sfida
* **[!UICONTROL Stato]**: stato corrente della sfida. Per informazioni dettagliate sulle transizioni di stato e sul ciclo di vita della sfida, vedere [Ciclo di vita della sfida](manage-challenges.md#challenge-lifecycle).
* **[!UICONTROL Descrizione]**: breve descrizione dello scopo della sfida
...
* **[!UICONTROL Data di inizio (UTC)]**: quando la richiesta di verifica diventa attiva
* **[!UICONTROL Data di fine (UTC)]**: quando scade la sfida
* **[!UICONTROL Ultima modifica]**: data e ora dell&#39;ultima modifica
* **[!UICONTROL Data di creazione]**: data di creazione della richiesta di verifica
...
* **Duplica una sfida**: seleziona l&#39;icona ![](assets/do-not-localize/Smock_More_18_N.svg) e scegli **[!UICONTROL Duplica]**
* **Elimina una bozza di richiesta**: seleziona l&#39;icona ![](assets/do-not-localize/Smock_More_18_N.svg) e scegli **[!UICONTROL Elimina]**

Per informazioni dettagliate sulla gestione delle sfide dopo la creazione, vedere [Gestire le sfide e le attività](manage-challenges.md).
...
* **[!UICONTROL Ultima modifica]**: data e ora dell&#39;ultima modifica
* **[!UICONTROL Ultima modifica eseguita da]**: ultimo utente che ha modificato l&#39;attività
* **[!UICONTROL Data creazione]**: data di creazione dell&#39;attività
* **[!UICONTROL Creato da]**: utente che ha creato l&#39;attività

Dalla scheda Attività è possibile eseguire azioni rapide sulle attività:
...
Per informazioni dettagliate sulla gestione delle attività dopo la creazione, vedere [Gestire le sfide e le attività](manage-challenges.md).
