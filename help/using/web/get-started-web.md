...
**In questa pagina:** introduzione al canale web in Adobe Journey Optimizer per eseguire l’authoring e distribuire visivamente esperienze web personalizzate all&#39;interno dei percorsi cliente e delle campagne.
...
* **[Generare contenuti web con l’IA](../content-management/generative-full-content.md)**: sfrutta l’IA per creare e ottimizzare contenuti web con testi e immagini.
* **[Utilizza decisioning nelle esperienze web](../experience-decisioning/use-decision-policy.md)**: personalizza le esperienze web con criteri decisionali per fornire le offerte più rilevanti a ogni visitatore.
