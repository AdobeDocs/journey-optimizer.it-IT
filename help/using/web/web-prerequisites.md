...
* Per accedere al Web Designer [!DNL Journey Optimizer], è necessario che sia installata un&#39;estensione del browser Google Chrome specifica. [Ulteriori informazioni](#visual-authoring-prerequesites)
...
* Attualmente in [!DNL Journey Optimizer] è possibile creare esperienze Web solo in **campagne**. [Ulteriori informazioni](../campaigns/create-campaign.md#configure)
...
>[!AVAILABILITY]
>
>Per il momento, il canale web non è disponibile per le organizzazioni che hanno acquistato il componente aggiuntivo Adobe **Healthcare Shield** e **Privacy and Security Shield**.
...
1. Cerca e passa all&#39;estensione del browser [Helper per editing video Adobe Experience Cloud](https://chrome.google.com/webstore/detail/adobe-experience-cloud-vi/kgmjjkfjacffaebgpkpcllakjifppnca){target="_blank"}.
