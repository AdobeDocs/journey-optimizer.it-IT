...
Questa pagina elenca tutte le nuove funzionalità e i miglioramenti introdotti in [!DNL Journey Optimizer]. È inoltre possibile consultare [ultimi aggiornamenti della documentazione](documentation-updates.md) per ulteriori modifiche.
...
<th><strong>Percorsi - Miglioramento del segmento di lettura</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
* **Formato dati nella visualizzazione globale** - È ora possibile alternare tra numeri e percentuali nella **Visualizzazione globale** della scheda **Esecuzione**. [Ulteriori informazioni](message-monitoring.md)
...
* **Ricerca** - In ogni pagina, ora puoi e cercare oggetti aziendali e gli articoli direttamente dal campo di ricerca Unified Experience Cloud. [Ulteriori informazioni](user-interface.md#unified-search)
...
* L’identità e lo spazio dei nomi sono ora visibili nella **[!UICONTROL Preview]** schermata. [Ulteriori informazioni](preview.md#preview-your-messages)
* Il numero di e-mail di prova per le bozze è ora limitato a 10.
* I caratteri consentiti per **Prefisso riga oggetto** nelle bozze ora sono limitati. [Ulteriori informazioni](preview.md#send-proofs)
