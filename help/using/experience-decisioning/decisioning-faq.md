...
**In questa pagina:** trova le risposte alle domande più frequenti sulle funzionalità di decisioning, tra cui le regole di limite massimo, le formule di classificazione e il comportamento del modello di IA, in modo da poter configurare e risolvere i problemi relativi al decisioning con sicurezza.
