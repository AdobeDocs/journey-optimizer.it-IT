...
**In questa pagina:** crea strategie di selezione riutilizzabili che associano una raccolta a un vincolo di idoneità e a un metodo di classificazione, in modo che i criteri di decisione possano determinare le offerte migliori da presentare a ciascun profilo.
...
>abstract="Una strategia di selezione è riutilizzabile e consiste in una raccolta associata a un vincolo di idoneità e a un metodo di ranking per determinare le offerte da visualizzare quando vengono selezionate in un criterio di decisione."
...
## Selezionare un metodo di ranking {#select-ranking-method}

>[!CONTEXTUALHELP]
>id="ajo_exd_strategy_ranking"
>title="Definire la modalità di ranking delle offerte"
>abstract="Se più offerte sono idonee per una determinata strategia di selezione, scegli il metodo che selezionerà l’offerta migliore per ciascun profilo durante la creazione di una strategia di selezione: priorità o formula di ranking."
>additional-url="https://experienceleague.adobe.com/docs/journey-optimizer/using/decisioning/experience-decisioning/decision-policies/create-decision.html?lang=it" text="Creare criteri di decisione"
...
* [Ranking basato su IA](#ai-ranking)
