---
title: Elencare posizionamenti exd
description: I posizionamenti Exd sono costituiti da raccolte associate a vincoli e metodi di classificazione per determinare le offerte.
...
TQID: https://experienceleague.adobe.com/901WN8WMM-UwDVVsJpidAuI-pXl4DrgYlru4NxoPxRI
...
# Elencare posizionamenti exd {#list-exd-placements}

Per visualizzare un elenco di tutti i posizionamenti exd, esegui una singola richiesta GET all’API della Libreria di offerte.
...
Puoi utilizzare i parametri di query per visualizzare e filtrare i risultati quando elenchi le risorse. Puoi filtrare per stato, canale e channelConfiguration.
...
In caso di esito positivo, la risposta restituisce un elenco di posizionamenti Exd a cui hai accesso.
