...
Per cercare una formula di classificazione specifica, effettua una richiesta GET all’API della Libreria di offerte che include l’ID nel percorso della richiesta.
