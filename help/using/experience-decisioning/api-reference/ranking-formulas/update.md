...
Puoi modificare o aggiornare una formula di classificazione effettuando una richiesta PUT all’API della libreria di offerte.

Per ulteriori informazioni su JSON PUT, incluse le operazioni disponibili, consulta la [documentazione ufficiale JSON PUT](http://jsonpatch.com/).
