...
**In questa pagina:** crea modelli di ottimizzazione automatica o di ottimizzazione personalizzata e collegali ai set di dati di conversione, in modo che il motore decisionale possa classificare automaticamente le offerte e distribuirne una con la conversione più elevata in ogni profilo.
...
## Accedere ai modelli AI {#access-ai-models}

Per accedere all&#39;elenco dei modelli AI, vai a **[!UICONTROL Decisioning]** > **[!UICONTROL Configurazione strategia]** e seleziona **[!UICONTROL Modelli AI]**. Tutti i modelli AI creati nell’istanza sono elencati qui.
...
1. Passa al menu **[!UICONTROL Decisioning]** > **[!UICONTROL Imposta strategia]** e seleziona **[!UICONTROL Modelli AI]**.
   ...
   Tutti i modelli di intelligenza artificiale creati finora nell’istanza sono elencati qui.
...
1. Salva e attiva il modello di intelligenza artificiale. Una volta che il modello è attivo, puoi [monitorarne lo stato di apprendimento e le prestazioni](ai-model-observability.md).
