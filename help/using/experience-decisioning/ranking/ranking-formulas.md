...
>[!TIP]
>
>Puoi anche creare, spiegare, simulare e ottimizzare le formule di classificazione a livello di conversazione utilizzando l&#39;abilità **Regole e classificazione** in [Collaboratore per le decisioni](../experience-decisioning-coworker-skills.md#rules-ranking).
...
1. Aggiungere varianti di test utilizzando uno dei metodi seguenti:
...
Dopo aver creato o generato una variante, puoi utilizzare gli attributi del [profilo di test Adobe Experience Platform](../../audience/creating-test-profiles.md) esistente per compilarne gli attributi.
