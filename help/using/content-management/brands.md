...
1. Dal menu avanzato di ogni sezione o categoria, puoi aggiungere riferimenti per estrarre automaticamente informazioni rilevanti sul brand o rieseguire l’estrazione per aggiornare le linee guida esistenti.
...
1. Fai clic su **[!UICONTROL Filtro]** per filtrare le linee guida per tipo di canale o elemento.
