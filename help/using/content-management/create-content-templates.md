...
**In questa pagina:** Scopri come creare modelli di contenuto da zero o salvando il contenuto della campagna o del percorso esistente come modello riutilizzabile in Adobe Journey Optimizer.
...
1. Fai clic su **[!UICONTROL Crea]** e progetta il contenuto in base alle esigenze, nello stesso modo in cui crei qualsiasi contenuto all&#39;interno di un percorso o di una campagna, in base al canale selezionato.
   ...
   * [Definire il contenuto degli SMS](../mobile/create-mobile-message.md#sms-content)
