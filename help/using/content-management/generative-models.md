...
**In questa pagina:** Scopri come aggiungere, configurare e gestire i modelli generativi Firefly incorporati, partner e personalizzati utilizzati per la generazione di immagini AI in Adobe Journey Optimizer.
...
È ora possibile selezionare qualsiasi modello generativo durante la creazione di immagini nel contenuto. [Ulteriori informazioni sulla generazione di immagini](generative-image.md).

## Aggiungi un modello generativo

>[!IMPORTANT]
>
>La creazione di modelli Firefly personalizzati richiede un contratto Firefly ETLA.
...
1. Immetti il **[!UICONTROL ID modello]**.
   ...
   +++ Trova il tuo ID modello Firefly

   1. Accedi al sito web di Firefly e naviga fino ai modelli che hai appreso.
   1. Accedi al menu [Anteprima e prova](https://helpx.adobe.com/firefly/web/work-with-enterprise-features/train-custom-models/train-firefly-custom-models.html#preview-and-test).
   1. Nell&#39;URL, individuare il valore dopo `customModelId=`. Copia questo valore da utilizzare come ID modello.

   Per ulteriori informazioni, consulta la [documentazione dei modelli personalizzati di Firefly](https://helpx.adobe.com/firefly/web/work-with-enterprise-features/train-custom-models/manage-custom-models.html).
...
Una volta configurata, puoi selezionare uno qualsiasi dei modelli generativi personalizzati durante la creazione di immagini nel contenuto. [Ulteriori informazioni sulla generazione di immagini](generative-image.md).
