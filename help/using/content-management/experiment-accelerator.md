...
>[!AVAILABILITY]
>
>**Experimentation Accelerator** richiede ai clienti di disporre di una licenza per Adobe Target o Adobe Journey Optimizer.
...
## Acceleratore per la sperimentazione di accesso
...
Puoi accedere a **[!UICONTROL Experimentation Accelerator]** dal menu a sinistra dal menu a discesa [!UICONTROL Sperimentazione] o tramite il selettore App. Gli utenti con una sola licenza di Target possono accedervi solo tramite il selettore App.
...
* **Per gli utenti di Adobe Target con Journey Optimizer**: tutte le attività A/B in Target vengono visualizzate in **[!UICONTROL Experimentation Accelerator]** nella sandbox di produzione di Journey Optimizer.
...
Per utilizzare **[!UICONTROL Experimentation Accelerator]**, devi accedere alla sandbox e alle seguenti autorizzazioni correlate.
