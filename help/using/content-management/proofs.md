...
Una volta [profili di test](test-profiles.md) , è possibile inviare bozze.
...
1. Seleziona la **Profili di test** da utilizzare per personalizzare il contenuto del messaggio.
