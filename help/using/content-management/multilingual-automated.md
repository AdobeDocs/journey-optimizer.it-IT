...
subfeature_v2: id: bc543dba-f0db-4234-b5da-877a5c1664e2id: ea4139d9-3405-4b34-ad6e-c3ca120cc269id: f8d2e9f0-69c9-40cd-890f-71336c8dfff7
...
**In questa pagina:** scopri come creare contenuti multilingue con traduzione automatica impostando un progetto di traduzione e le impostazioni della lingua, quindi inviando il contenuto della tua campagna o del tuo percorso a un provider di traduzione per la revisione e la pubblicazione.
...
1. Inizia a creare le condizioni aggiungendo un attributo, un evento o un pubblico per definire il gruppo target.
   ...
   1. Accedi al menu **[!UICONTROL Regole]** e crea una nuova regola. Informazioni dettagliate su come creare regole sono disponibili nella [!DNL Adobe Experience Platform] [documentazione sulla raccolta dati](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules){target="_blank"}
...
1. Inizia creando e configurando la tua notifica e-mail, SMS o push [campagna](../campaigns/create-campaign.md) o [percorso](../building-journeys/journey-action.md) in base alle tue esigenze.
