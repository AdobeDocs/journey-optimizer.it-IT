...
Per definire contenuti specifici che consentano agli utenti di selezionare e inviare le proprie scelte dalla pagina di destinazione, utilizza la funzione **[!UICONTROL Form]** componente. Per farlo, segui i passaggi seguenti.
...
1. Posizionare il puntatore del mouse nella pagina secondaria in cui si desidera inserire il testo e selezionare **[!UICONTROL Add personalization]** dalla barra degli strumenti contestuale.

   ![](assets/lp_designer-form-subpage-perso.png)

1. In **[!UICONTROL Edit personalization]** finestra, seleziona **[!UICONTROL Contextual attributes]** > **[!UICONTROL Landing Pages]** > **[!UICONTROL Primary Page Context]** > **[!UICONTROL Subscription]**.
