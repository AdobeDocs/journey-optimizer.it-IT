...
feature_v2: id: bb359667-ec7d-4d4b-8663-5850fc219d32id: b856530c-d60b-42d8-a19d-df2dfd7fe62aid: d556b755-390a-43f0-be32-a08cf6236126
...
**In questa pagina:** configura utenti, autorizzazioni, sandbox e configurazioni dei canali in modo che i tuoi team possano lavorare in Adobe Journey Optimizer in modo sicuro ed efficiente.
...
1. **Imposta le configurazioni dei canali**. Definisci tutti i parametri tecnici richiesti per e-mail, SMS, notifiche push, push web, direct mail e altri canali:
   ...
   * Configura il **Canale SMS** per impostare tutti i parametri tecnici richiesti per gli SMS. [Ulteriori informazioni](../../mobile/mobile-configuration.md)
