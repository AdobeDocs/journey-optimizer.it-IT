...
title: Quale funzionalità Journey Optimizer è in grado di eseguire questo processo?
description: Una guida decisionale che mappa gli obiettivi comuni dei professionisti sulla giusta funzionalità di Adobe Journey Optimizer, con esercitazioni pratiche, per trovare lo strumento giusto per quello che desideri eseguire e iniziare rapidamente.
feature: Get Started
...
# Quale funzionalità Journey Optimizer è in grado di eseguire questo processo? {#ajo-use-case-guide}
...
Inizia con il canale su cui desideri inviare: [E-mail](../email/get-started-email.md) · [Push](../push/get-started-push.md) · [SMS/MMS/RCS](../mobile/get-started-mobile.md) · [Web](../web/get-started-web.md) · [In-app](../in-app/get-started-in-app.md). Per informazioni specifiche su dispositivi mobili, visita il [Mobile Learning Hub](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}.

## Misurazione e ottimizzazione {#measure-optimize}

Monitora le prestazioni e perfeziona: [Rapporti live](../reports/live-report.md) · [Monitora e analizza il percorso con rapporti live](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports){target="_blank"}. Per analizzare gli esperimenti e ottenere i consigli del passaggio successivo, utilizza l&#39;[agente di sperimentazione](ai-features.md#experimentation-agent) **(AI)** ([esercitazione](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/tutorials/experimentation/experimentation-agent-overview){target="_blank"}).
