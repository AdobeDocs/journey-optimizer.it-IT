...
title: Trovate la giusta funzionalità Journey Optimizer per il vostro obiettivo
...
Usa questa pagina come router rapido: cerca l’obiettivo e passa direttamente alla funzionalità giusta. Se preferisci seguire le istruzioni e i video guidati, inizia con [l&#39;hub di onboarding](onboarding-hub.md).
...
>[!TIP]
>
>Ti avvicini ora a Journey Optimizer? Inizia con [Onboarding hub](onboarding-hub.md) per istruzioni dettagliate, casi d&#39;uso curati e video. Puoi anche sfogliare le [esercitazioni complete su Journey Optimizer](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/tutorials/overview){target="_blank"} (video e procedure guidate), seguire una [playlist video](https://experienceleague.adobe.com/it/playlists?solution=Journey+Optimizer){target="_blank"} curata da esperti ed esercitarti in una [sandbox di formazione](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/configure-a-training-sandbox/introduction-and-prerequisites){target="_blank"} o con le [sfide pratiche](https://experienceleague.adobe.com/it/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}.
