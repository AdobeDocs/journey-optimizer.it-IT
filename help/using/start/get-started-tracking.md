...
Comprendere come i clienti interagiscono con le tue comunicazioni è fondamentale per creare esperienze significative e risultati guida. Journey Optimizer offre funzionalità complete di monitoraggio e monitoraggio che forniscono visibilità sul comportamento dei clienti, sulle prestazioni di consegna e sullo stato del sistema, il tutto nel rispetto della privacy e nel rispetto della conformità.

>[!BEGINSHADEBOX]

**Elementi di cui tenere traccia in Journey Optimizer:**
...
### Tracciamento delle notifiche push {#push-tracking}
...
### Tracciamento dei messaggi in-app {#inapp-tracking}
...
### Tracciamento di SMS e MMS {#sms-tracking}
...
### Tracciamento delle esperienze basato su codice {#code-based-tracking}
...
### Tracciamento delle schede di contenuto {#content-card-tracking}
...
## Monitorare le pagine di destinazione {#landing-page-tracking}
...
## Gestire le prestazioni di ottimizzazione {#optimization-tracking}

Journey Optimizer tiene traccia automaticamente degli esperimenti di ottimizzazione e delle strategie di targeting. Configura le ottimizzazioni per garantire la corretta raccolta dei dati.
...
**Funzionamento del tracciamento:**
...
## Passaggi successivi: accedere ai dati di tracciamento {#access-tracking-data}

Una volta configurato il tracciamento, puoi accedere ai tuoi dati tramite le funzionalità di reporting integrate di Journey Optimizer:

* **Monitoraggio in tempo reale** - Visualizza le metriche live durante l&#39;esecuzione di percorsi e campagne per identificare rapidamente i problemi
* **Analisi cronologica** - Analizza le prestazioni passate per comprendere le tendenze e ottimizzare le campagne future
* **Analisi avanzate** - Connettiti a Customer Journey Analytics per sofisticate analisi cross-channel e modellazione di attribuzione

[Introduzione al reporting](../reports/gs-reports.md) | [Informazioni sull&#39;integrazione di Customer Journey Analytics](../reports/cja-ajo.md)

## Esplora gli argomenti chiave {#explore-topics}
