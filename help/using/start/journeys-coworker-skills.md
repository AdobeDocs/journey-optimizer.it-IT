...
title: Competenze CX Coworker per i percorsi
description: Scopri le competenze CX Coworker disponibili per la creazione, la generazione di contenuti e l’analisi di percorsi in Adobe Journey Optimizer, con istruzioni approfondite e prompt di esempio.
feature: Overview
