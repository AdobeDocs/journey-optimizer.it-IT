...
* **[!UICONTROL Canali]**: utilizza questa sezione per configurare i canali, inclusi i sottodomini, le configurazioni e le impostazioni di recapito messaggi. [Ulteriori informazioni](../configuration/get-started-configuration.md)
