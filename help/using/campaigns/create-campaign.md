...
Per creare una nuova campagna, accedi al **[!UICONTROL Campaigns]** menu, quindi fai clic su **[!UICONTROL Create campaign]**. Puoi anche duplicare una campagna live esistente per crearne una nuova. [Ulteriori informazioni](modify-stop-campaign.md#duplicate)
...
1. In **[!UICONTROL Properties]** Specifica come eseguire la campagna. Sono disponibili due tipi di campagne:
...
1. In **[!UICONTROL Actions]** scegli il canale e la superficie del canale da utilizzare per inviare il messaggio.
...
1. Fai clic su **[!UICONTROL Create]** per creare la campagna.
...
Se non desideri eseguire la campagna subito dopo l’attivazione, puoi specificare una data e un’ora in cui inviare il messaggio utilizzando **[!UICONTROL Campaign start]** opzione . La **[!UICONTROL Campaign end]** consente di specificare quando interrompere l’esecuzione di una campagna ricorrente.
